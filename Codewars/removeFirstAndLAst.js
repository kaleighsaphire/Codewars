...
/* Parameters: given a string of numbers separated by commas
Return: a string with the first and last numbers removed, separated with spaces
Example: see above
Pseudo Code: string split ',', slice first and last, join(' ')  */

function array(arr){
    let string = arr.split(',').slice(1, -1).join(' ')
