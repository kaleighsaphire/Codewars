...
P: given an array of arrays, each array contains and age and a handicap
R: the array with each array's qualifier of "open" or senior, depending on 
their age and handicap
E:input =  [[18, 20], [45, 2], [61, 12], [37, 6], [21, 21], [78, 9]]
output = ["Open", "Open", "Senior", "Open", "Open", "Senior"]
PC: map array, for each element with index 0 that is greater than 54 
and index 1 of greater than 7 return "Senior" else return "Open"
*/

function openOrSenior(data) {
    return data.map((e) => e[0] > 54 && e[1] > 7 ? e = "Senior" : "Open")
}