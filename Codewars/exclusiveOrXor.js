...
// is to define a function xor(a, b) where a and b are the two expressions to be evaluated. Your xor 
// function should have the behaviour described above, returning true if exactly one of the two expressions 
// evaluate to true, false otherwise.

/* Parameters: take in 2 expressions for evaluation
Return: true if one is true and one false, false otherwise
Example: (true, true) -> false (false, true) --> true
Pseudo Code: if a !== b return true */
