...
/* Parameters: take in an animal
Return: small if argument is alligator, otherwise wide
Example: (cow) -> wide (alligator) -> small
Pseudo Code: animal.toLowercase() == alligator ? small : wide */
