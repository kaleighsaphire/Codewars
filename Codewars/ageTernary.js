...
/*
Parameters: given an age
Return: statement whether age correlates to kid, teen, adult, or elderly
Example: 18 -> "Youre an adult"
Pseudo Code: convert else if to ternary statement. 
 */
...
function describeAge(age) {
  ...
  let describeAge = age => { return `You're a(n) ${age<= 12?"kid":age >= 13 && age <= 17?"teenager":age >=18&&age<=64?"adult":"elderly"}`}

  let describeAge = age => { return `You're a(n) ${age < 13?"kid":age < 18?"teenager":age<65?"adult":"elderly"}`}
